    ...
    lessons: [
      {
        ...
        // ],
        lessonsDescription: "У цьому розділі ви освоїте основи системи контролю версій Git і платформу GitHub. Ви навчитесь працювати з командною строкою та виконувати основні операції з файлами, такими як їх створення та видалення. Ви дізнаєтесь, як організовувати код за допомогою репозиторіїв GitHub, управляти гілками та злиттями (merge). Крім того, ви розглянете приклад робочого процесу розробника і дізнаєтесь, як розгортати веб-сайти за допомогою GitHub Pages.",
      },
      {
      ...
      },
      {
        ...
        //   "Цикл for...in",
        // ],
        lessonsDescription: "У цьому розділі ви дізнаєтеся, як працювати з масивами в JavaScript: створювати та редагувати їх, використовувати різноманітні методи для маніпуляцій (додавання, видалення, злиття, реверсування) та освоїти принципи роботи з об'єктами. Ви навчитеся використовувати цикли для автоматизації процесів, включаючи for, while, та for...of, а також дізнаєтеся про різницю між масивами і об'єктами, способи їх порівняння і властивості. Опанування цих тем допоможе вам створювати більш ефективний і динамічний код.",
      },
      {
      ...
      },
      {
        ...
        //   "Motivation App",
        // ],
        lessonsDescription: "У цьому розділі ви дізнаєтеся про нові можливості JavaScript, такі як параметри функцій за замовченням і використання оператора spread для масивів та об'єктів. Ви освоїте концепцію об'єкта Arguments, функціональність rest аргументів, а також деструктуризацію масивів, об'єктів і параметрів функцій. Ви також навчитеся використовувати скорочений запис властивостей об'єкта, обчислювальні властивості, додавати методи до об'єкта, і розбиратися в контексті this в методах та функціях.",
      },
      {
      ...
      },
      {
        ...
        //   "Події input, change",
        // ],
        lessonsDescription: "У цьому розділі ви вивчите основи обробки подій у JavaScript. Ви дізнаєтеся про властивості подій та використання addEventListener для прив’язки обробників подій до елементів. Ви навчитеся обробляти події з клавіатури, такі як keypress, keyup і keydown, а також події форм, включаючи preventDefault. Ви також ознайомитеся з подіями для елементів введення, такими як input і change.",
      },
      {
