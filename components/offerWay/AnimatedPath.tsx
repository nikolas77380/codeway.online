  ...
  return (
    ...
    >
      ...
      >
        <motion.path
          id="mainMobile"
          d="M38 103V107C38 107 38.5 118.5 23 145C-10 191 64.1072 201.077 64.5 247C64.9356 297.923 19.7314 285.079 2.50001 333C-29 454 360 397.5 379 521.5C398 645.5 2 612 12 802C22 992 293.5 818 205.5 1353.5"
          stroke="#A855F7"
          strokeWidth="4"
          strokeLinejoin="round"
          style={{ pathLength: smoothPathLength }}
        ...
        <motion.path
          id="pointMobile"
          d="M62.5 31C61 56 39.5 71 38 104C35 69.5 14 56 13 31C12 5 30.5 0.500003 38.5 0.5C46.5 0.499997 64 4.99998 62.5 31Z"
          stroke="#A855F7"
          strokeWidth="4"
          strokeLinejoin="round"
          style={{ pathLength: smoothPointLength }}
